...
function probeInit() {
	...
	audioContext.audioWorklet.addModule('MDAOVER.wasm.js')
	.then((v) => {
		audioContext.audioWorklet.addModule('MDAOVER.js')
		.then((v) => {
			audioContext.audioWorklet.addModule('MDAOVER.processor.js')
			.then((v) => {
				audioWorkletNode = new AudioWorkletNode(audioContext, 'MDAOVERProcessorClass', {
