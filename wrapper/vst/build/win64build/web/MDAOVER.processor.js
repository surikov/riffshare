...
class MDAOVERProcessor extends AudioWorkletProcessor {
	constructor(options) {
		super(options);
		//this.setup(44100);
	...
	setup(sampleRate) {
		...
		this.vst = AudioWorkletGlobalScope.WAM.MDAOVER;
		this.testID = '203C7009042A4AC2A515CFF1DF647E92';
		this.testNum = 0;
...
registerProcessor("MDAOVERProcessorClass", MDAOVERProcessor);
