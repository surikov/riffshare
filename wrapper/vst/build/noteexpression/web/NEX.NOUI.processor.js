...
class NEXProcessor extends AudioWorkletProcessor {
	constructor(options) {
		super(options);
		//this.setup(44100);
	...
	setup(sampleRate) {
		...
		this.vst = AudioWorkletGlobalScope.WAM.NEX;
		this.testID = '6EE65CD1B83A4AF480AA7929AEA6B8A0';
		this.testNum = 0;
...
registerProcessor("NEXProcessorClass", NEXProcessor);
