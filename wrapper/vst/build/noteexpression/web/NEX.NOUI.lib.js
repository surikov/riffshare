...
function probeInit() {
	...
	audioContext.audioWorklet.addModule('NEX.wasm.js')
	.then((v) => {
		audioContext.audioWorklet.addModule('NEX.js')
		.then((v) => {
			audioContext.audioWorklet.addModule('NEX.NOUI.processor.js')
			.then((v) => {
				audioWorkletNode = new AudioWorkletNode(audioContext, 'NEXProcessorClass', {
