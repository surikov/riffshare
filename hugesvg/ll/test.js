...
function RakeView(rakeName, contentName, width, height) {
	...
	me.rakeMouseMove = function (mouseEvent) {
		...
		me.startMouseScreenX = mouseEvent.screenX;
		me.startMouseScreenY = mouseEvent.screenY;
		me.setTransform(me.contentDiv, me.translateX, me.translateY);
	};
	...
	me.adjustCountentPosition = function () {
		...
		if(me.rakeDiv.clientWidth>me.innerWidth){
			minX=(me.rakeDiv.clientWidth-me.innerWidth)/2;
			maxX=me.rakeDiv.clientWidth-(me.rakeDiv.clientWidth-me.innerWidth)/2;
		}
		if(me.rakeDiv.clientHeight>me.innerHeight){
			minY=(me.rakeDiv.clientHeight-me.innerHeight)/2;
			maxY=me.rakeDiv.clientHeight-(me.rakeDiv.clientHeight-me.innerHeight)/2;
		}
