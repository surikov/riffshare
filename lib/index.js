...
FretChordSheet.prototype.init = function () {
	...
	this.tiler.addZoomLevel(1.3, function (left, top, width, height) {
		...
		me.layerBack.renderGroup(100, 200, 300, 400, 'btn1', left, top, width, height, function (tg) {
			me.tiler.addSpot('btn1', tg.x, tg.y, tg.w, tg.h, function () {
				console.log('btn1 click');
			}, false, false);
			me.layerBack.tileRectangle(tg.g, tg.x, tg.y, tg.w, tg.h, '#f00');
		});
		me.layerBack.renderGroup(450, 200, 300, 400, 'btn2', left, top, width, height, function (tg) {
			me.tiler.addSpot('btn2', tg.x, tg.y, tg.w, tg.h, function () {
				console.log('btn2 click');
			}, false, false);
			me.layerBack.tileRectangle(tg.g, tg.x, tg.y, tg.w, tg.h, '#ff0');
		});
		me.layerBack.renderGroup(800, 200, 300, 400, 'btn3', left, top, width, height, function (tg) {
			me.tiler.addSpot('btn3', tg.x, tg.y, tg.w, tg.h, function () {
