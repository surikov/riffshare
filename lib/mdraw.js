...
FretChordSheet.prototype.tileDrumRollSpot = function (left, top, width, height, layer, lineWidth) {
	...
	layer.renderGroup(this.margins.sheetLeft //
		, this.margins.drumsTop//
		, (1 + this.options.measureCount) * this.options.measureLen * 3 * layer.tapSize//
		, 8 * 3 * layer.tapSize//
		, 'drspt', left, top, width, height, function (tg) {
			//layer.tileRectangle(tg.g, tg.x, tg.y , tg.w,tg.h, 'rgba(255,0,0,0.2)');
...
FretChordSheet.prototype.clickedBeat = function () {
	...
	console.log(this.options.feel,'beatMeasure', beatMeasure, 'beatQuarter', beatQuarter, 'remainX', remainX, 'r', r);
	return 0;
};
