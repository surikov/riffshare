...
FretChordSheet.prototype.tileMenu = function ( left, top, width, height, layer, lineWidth) {
	var me = this;
	layer.renderGroup(0, 0, me.margins.sheetLeft, this.contentHeight, 'menu', left, top, width, height, function (tg) {
		me.tileRange(tg, 'btnFeel', 3 * me.tiler.tapSize, 1 * 3 * me.tiler.tapSize, 3 * me.tiler.tapSize, me.margins.sheetLeft - 6 * me.tiler.tapSize, 1+me.options.feel, 3, 'Feel '+me.feelNames[me.options.feel], function (v) {
