...
FretChordSheet.prototype.userActionAddNote = function (tone, beat192, len192, pitch,shift) {
	var one = { tone: tone,  beat192: beat192, len192: len192, pitch:pitch,shift: shift };
	var me = this;
	this.pushAction({
		caption: 'Add note ' + tone+'/'+pitch+'-'+beat192,
		undo: function () {
			me.dropNote(one);
		},
		redo: function () {
...
FretChordSheet.prototype.userActionAddDrum = function (kind, beat192, len192) {
	var one = { kind: kind,  beat192: beat192, len192: len192};
	var me = this;
	this.pushAction({
		caption: 'Add drum ' + kind+'/'+beat192,
		undo: function () {
			me.dropDrum(one);
		},
		redo: function () {
