...
RiffShare2D.prototype.tileMeiumSongOptions = function (layer, left, top, width, height, ratio) {
	...
	if (g) {
		...
		if (true, riffShare2d.cellWidth >= this.cellWidth3) {
			this.addSimpleStuckButton('btMenWi3', '', g, x + 2 * h / 7, y + 3 * h / 6, h / 7);
		} else {
			this.addHollowStuckButton('btMenWi3', '', g, x + 2 * h / 7, y + 3 * h / 6, h / 7, function () {
				riffShare2d.cellWidth = riffShare2d.cellWidth3;
				//console.log('b');
			});
		}
		if (riffShare2d.cellWidth >= this.cellWidth2) {
			this.addSimpleStuckButton('btMenWi2', '', g, x + 1 * h / 7, y + 3 * h / 6, h / 7, function () {
				riffShare2d.cellWidth = riffShare2d.cellWidth2;
				//console.log('c');
			});
		} else {
			this.addHollowStuckButton('btMenWi2', '', g, x + 1 * h / 7, y + 3 * h / 6, h / 7, function () {
				riffShare2d.cellWidth = riffShare2d.cellWidth2;
				//console.log('d');
			});
		}
		this.addSimpleStuckButton('btMenWi1', 'Cell width', g, x + 0 * h / 7, y + 3 * h / 6, h / 7, function () {
			riffShare2d.cellWidth = riffShare2d.cellWidth1;
			//console.log('e');
		});
		var curVol = Math.round(100 * this.currentSong.volumes[0].value / 127);

		if (curVol > 90) {
			this.addSimpleStuckButton('btMenLoud10', '' + curVol + '%', g, x + 5 * h / 7, y + 4 * h / 6, h / 7, null);
		} else {
			this.addHollowStuckButton('btMenLoud10', '' + curVol + '%', g, x + 5 * h / 7, y + 4 * h / 6, h / 7, function () {
		...
		if (curVol > 70) {
			this.addSimpleStuckButton('btMenLoud8', '', g, x + 4 * h / 7, y + 4 * h / 6, h / 7, function () {
				riffShare2d.currentSong.volumes = [{
						position : 0,
						value : 80 * 127 / 100
					}
			...
			this.addHollowStuckButton('btMenLoud8', '', g, x + 4 * h / 7, y + 4 * h / 6, h / 7, function () {
				riffShare2d.currentSong.volumes = [{
						position : 0,
						value : 80 * 127 / 100
					}
		...
		if (curVol > 50) {
			this.addSimpleStuckButton('btMenLoud6', '', g, x + 3 * h / 7, y + 4 * h / 6, h / 7, function () {
				riffShare2d.currentSong.volumes = [{
						position : 0,
						value : 60 * 127 / 100
					}
			...
			this.addHollowStuckButton('btMenLoud6', '', g, x + 3 * h / 7, y + 4 * h / 6, h / 7, function () {
				riffShare2d.currentSong.volumes = [{
						position : 0,
						value : 60 * 127 / 100
					}
		...
		if (curVol > 30) {
			this.addSimpleStuckButton('btMenLoud4', '', g, x + 2 * h / 7, y + 4 * h / 6, h / 7, function () {
				riffShare2d.currentSong.volumes = [{
						position : 0,
						value : 40 * 127 / 100
					}
			...
			this.addHollowStuckButton('btMenLoud4', '', g, x + 2 * h / 7, y + 4 * h / 6, h / 7, function () {
				riffShare2d.currentSong.volumes = [{
						position : 0,
						value : 40 * 127 / 100
					}
		...
		if (curVol > 10) {
			this.addSimpleStuckButton('btMenLoud2', '', g, x + 1 * h / 7, y + 4 * h / 6, h / 7, function () {
				riffShare2d.currentSong.volumes = [{
						position : 0,
						value : 20 * 127 / 100
					}
			...
			this.addHollowStuckButton('btMenLoud2', '', g, x + 1 * h / 7, y + 4 * h / 6, h / 7, function () {
				riffShare2d.currentSong.volumes = [{
						position : 0,
						value : 20 * 127 / 100
					}
		...
		this.addSimpleStuckButton('btMenLoud0', 'Volume', g, x + 0 * h / 7, y + 4 * h / 6, h / 7, function () {
			riffShare2d.currentSong.volumes = [{
					position : 0,
					value : 0 * 127 / 100
				}
		...
		if (curEch > 1) {
			this.addSimpleStuckButton('btMenEch2', '' + (curEch * 50) + '%', g, x + 2 * h / 7, y + 5 * h / 6, h / 7, null);
		} else {
			this.addHollowStuckButton('btMenEch2', '' + (curEch * 50) + '%', g, x + 2 * h / 7, y + 5 * h / 6, h / 7, function () {
				riffShare2d.currentSong.echo = 2;
			});
		}

		if (curEch > 0) {
			this.addSimpleStuckButton('btMenEch1', '', g, x + 1 * h / 7, y + 5 * h / 6, h / 7, function () {
				riffShare2d.currentSong.echo = 1;
			});
		} else {
			this.addHollowStuckButton('btMenEch1', '', g, x + 1 * h / 7, y + 5 * h / 6, h / 7, function () {
				riffShare2d.currentSong.echo = 1;
			});
		}

		this.addSimpleStuckButton('btMenEch0', 'Echo', g, x + 0 * h / 7, y + 5 * h / 6, h / 7, function () {
